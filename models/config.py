...
def parse_args():
    ...
    parser.add_argument('--use_batch',default=True,type = bool,help = 'train on batch')
    parser.add_argument('--batch_size',default=2000,type = int,help = 'batchsize for train')
    parser.add_argument('--batch_update',default=50,type = int,help = 'batchsize for updates')
    parser.add_argument('--epochs',default=20,type = int,help='number of total epochs to run')
    parser.add_argument('--lr',default=0.01,type = float,help= 'learning rate')
    parser.add_argument('--wd',default='1e-4',type = float,help = 'weight decay')
    parser.add_argument('--optim', default='adagrad', help='optimizer')
    parser.add_argument('--seed', default=2454, type=int, help='random seed')
